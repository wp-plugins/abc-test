...
class abcTest {
	...
	public static function edit()
	{
		...
		$sql = sprintf("SELECT * FROM %sabctest_main WHERE id_test = %d", $wpdb->prefix, self::sanitizeid());
	...
	public static function delete()
	{
		...
		$sql = sprintf("DELETE FROM %sabctest_main WHERE id_test = %d", $wpdb->prefix, self::sanitizeid());
		
		$wpdb->query($sql);

		// cancella dati correlati
		$sql = sprintf("DELETE FROM %sabctest_options WHERE id_test = %d", $wpdb->prefix, self::sanitizeid());
